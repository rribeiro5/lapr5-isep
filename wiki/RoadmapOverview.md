...
Este SAD descreve a arquitetura de software do sistema a desenvolver por solicitação da Graphs4Social para simulação de uma rede social, em que o jogador/utilizador tem por objetivo criar a maior e mais forte rede social possível, através do cumprimento de missões, de forma a aumentar a rede e subir na leaderboard.
